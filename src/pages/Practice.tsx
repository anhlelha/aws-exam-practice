...
export default function Practice() {
    ...
    const selectAnswer = async (answerId: number) => {
        ...
        if (question.is_multiple_choice) {
            ...
            // Single select behavior (replace)
    ...
    return (
        <div className="fade-in">
            <header className="page-header">
                <div className="page-header-content">
                    <div>
                        <h1 className="page-title">Exam Practice</h1>
                        <p className="page-subtitle">Select a test to begin your practice session.</p>
                    </div>
                </div>
            </header>
            ...
            <div className="page-body">
                <div style={{ maxWidth: '800px', margin: '0 auto' }}>
                        ...
                        <div className="card-body">
                            {tests.length === 0 ? (
                                <div style={{ textAlign: 'center', padding: '48px', color: 'var(--text-muted)' }}>
                                    No tests available. Please ask your administrator to create some tests.
                                </div>
                            ) : (
                                    ...
                                    {tests.map(test => (
                                        ...
                                        >
                                            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
                                                ...
                                                <span className="tag info">{test.duration_minutes} min</span>
                                            </div>
                            ...
                            {selectedTestId && (
                                <div style={{ marginTop: '24px', borderTop: '1px solid var(--border-color)', paddingTop: '24px' }}>
                                    <div style={{ marginBottom: '16px' }}>
                                        <label style={{ display: 'block', marginBottom: '8px', fontWeight: 500 }}>Practice Mode</label>
                                        <div style={{ display: 'flex', gap: '16px' }}>
                                            ...
                                            <label style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer' }}>
                                                <input
                                                    ...
                                                    name="mode"
                                                    value="non-timed"
                                                    checked={mode === 'non-timed'}
                                                    onChange={() => setMode('non-timed')}
                                                />
                                                Non-Timed Mode (Learning)
                                            </label>
                                        </div>
                                    </div>
                                    <button className="btn btn-primary btn-lg w-100" onClick={startPractice}>
                    ...
                    <div style={{ marginTop: '24px', textAlign: 'center' }}>
                        <p style={{ color: 'var(--text-muted)' }}>Need to create a new test?</p>
